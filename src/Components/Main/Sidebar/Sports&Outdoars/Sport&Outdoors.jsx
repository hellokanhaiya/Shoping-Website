...
import styles from "./Sport&Outdoors.module.css";
import { HiOutlineShoppingCart } from "react-icons/hi";
import "swiper/swiper-bundle.css";

const ITEMS_PER_PAGE = 12;

const SportOutdoorscompoents = () => {
    ...
    <div className="container m-6 mx-auto">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
        {currentItems.map((item, index) => (
          <div
            key={index}
            className={`bg-white rounded-md shadow-md overflow-hidden ${styles.hoverwidth} anotherclass`}
          >
            <Link
              to={{
...
export default SportOutdoorscompoents;

      ...
      <div className="flex flex-wrap -mx-2">
        {currentItems.map((item, index) => (
          ...
          >
            ...
            >
              <div className="cursor-pointer group-hover:bg-white">
                ...
                <div className="mt-6">
                  <h3 className="mb-6 text-sm font-medium md:text-base lg:text-lg group-hover:text-blue-500">
                    {item.title}
                  </h3>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-base font-bold text-red-500 md:text-lg">
                  {item.discountPrice}
                </p>
              </div>
              <div className="relative">
            ...
            <div className="py-4 border-t">
              <ul className="pl-2 ml-5 text-xs list-disc md:text-sm">

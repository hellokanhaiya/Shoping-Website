...
import styles from "./AsusComponent.module.css";
    ...
    <div className="z-50 w-full">
      <div className="flex flex-wrap w-full p-4">
        {currentItems.map((item, index) => (
          <div
            className="w-full px-2 mb-4 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5"
            key={index}
          >
            <Link
              to={{
            ...
            >
              <div className="cursor-pointer hover:bg-white">
                ...
                <div className="mt-6">
                  <h3 className="mb-6 text-sm font-medium hover:text-blue-500">
                    {item.title}
                  </h3>
            ...
            <div className="py-4 something1 something">
              <hr />
